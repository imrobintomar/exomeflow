...
#
# ── Build & push ────────────────────────────────────────────
#   docker build -t itsrobintomar/exomeflow:2.2.12 .
#   docker tag  itsrobintomar/exomeflow:2.2.12 itsrobintomar/exomeflow:latest
#   docker push itsrobintomar/exomeflow:2.2.12
...
LABEL org.opencontainers.image.version="2.2.12"
...
# ── ExomeFlow ────────────────────────────────────────────────────────────────
RUN pip install --no-cache-dir exomeflow==2.2.12
