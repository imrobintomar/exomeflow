...
#
# ── Build & push ────────────────────────────────────────────
#   docker build -t itsrobintomar/exomeflow:2.2.4 .
#   docker tag  itsrobintomar/exomeflow:2.2.4 itsrobintomar/exomeflow:latest
#   docker push itsrobintomar/exomeflow:2.2.4
...
# ── ExomeFlow ────────────────────────────────────────────────────────────────
RUN pip install --no-cache-dir exomeflow==2.2.4
