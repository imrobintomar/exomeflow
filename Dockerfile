...
#
# ── Build & push ────────────────────────────────────────────
#   docker build -t itsrobintomar/exomeflow:2.2.15 .
#   docker tag  itsrobintomar/exomeflow:2.2.15 itsrobintomar/exomeflow:latest
#   docker push itsrobintomar/exomeflow:2.2.15
...
LABEL org.opencontainers.image.version="2.2.15"
...
# ── ExomeFlow ────────────────────────────────────────────────────────────────
RUN pip install --no-cache-dir exomeflow==2.2.15
