...
#
# ── Build & push ────────────────────────────────────────────
#   docker build -t itsrobintomar/exomeflow:2.1.1 .
#   docker tag  itsrobintomar/exomeflow:2.1.1 itsrobintomar/exomeflow:latest
#   docker push itsrobintomar/exomeflow:2.1.1
